from TwoCompartment.PK_model.pk_2C_model_simulations import two_comp_multi_dose_simulation, \
    two_comp_multi_dose_with_delay_simulation

from plot_simulations_with_AUC import plot_multi_dose_output, plot_multi_dose_delay_output
...
t2, C2 = two_comp_multi_dose_with_delay_simulation(num_days, num_dose, interval, [dose_1]*num_dose, delay)
